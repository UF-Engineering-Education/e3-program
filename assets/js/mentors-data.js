/* ===========================================================================
   ...
   NOTE: mentors are paired one-to-one with fellows, but a mentor does NOT have
   to come from the fellow's own department. The department filter chips and the
